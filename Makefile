...
mcp-add-claude-dev: go-build-current
	...
	claude mcp add --transport stdio acdc-dev $(GOBIN)/$(PROGRAMNAME) -- --config $(GOBASE)/examples/sample-content/mcp-metadata.yaml
...
mcp-add-gemini-dev: go-build-current
	...
	gemini mcp add acdc-dev $(GOBIN)/$(PROGRAMNAME) -- --config $(GOBASE)/examples/sample-content/mcp-metadata.yaml
